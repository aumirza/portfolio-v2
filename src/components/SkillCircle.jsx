...
export const SkillCircle = ({ name, icon, level }) => {
  return (
    <div className="flex flex-col items-center hover:cursor-pointer hover:scale-105">
      <div className="flex items-center justify-center mb-3 rounded bg-card w-14 h-14 md:w-16 md:h-16">
        <img
          className="w-10 h-10 md:h-12 md:w-12 filter brightness-0 hover:brightness-75"
          src={icon}
          alt={name}
        />
      </div>
