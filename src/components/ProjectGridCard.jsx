...
export const ProjectGridCard = ({ project }) => {
  ...
  return (
    <div className="max-w-[20rem] mx-auto p-2 bg-secondary dark:bg-primary text-white dark:text-secondary rounded-lg shadow-md hover:-translate-y-3 hover:shadow-xl flex flex-col items-center transition-all ease-in-out duration-500">
